...
const ProductNumber = styled.div`
  ...
  .active-${props => props.activeProduct}{
    color: red;
  }
    ...
    <Fragment>
      ...
      <ChildWrapper>
        <Container>
          ...
          <ProductNumber activeProduct={activeProduct}>
              <button onClick={()=>changeProduct(0)} className="active-0">1</button>
              <button onClick={()=>changeProduct(1)} className="active-1">2</button>
              <button onClick={()=>changeProduct(2)} className="active-2">3</button>
          </ProductNumber>

          {/* active product */}
          <ProductsContainer>
            <LatestProductActive activeProduct={products[activeProduct]} showBackdrop={showBackdrop} setShowBackdrop={setShowBackdrop} />
          </ProductsContainer>
        </Container>
      </ChildWrapper>
    </Fragment>
